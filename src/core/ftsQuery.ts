 ...
 * costs about as much as the full scan it replaces while returning arbitrary
 * results. Callers use this to skip the local backfill and rely on the
 * upstream search instead.
 */
