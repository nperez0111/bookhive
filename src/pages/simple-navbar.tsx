  ...
  return (
    <header class="top-bar border-border bg-background border-b">
      <div class="flex h-16 items-center gap-3 px-4 lg:px-6">
        <a
          href={homeUrl}
          class="flex shrink-0 items-center min-h-10 min-w-10 rounded-md px-2 transition-[transform,background-color] duration-150 ease-out hover:bg-muted active:scale-[0.96]"
        >
