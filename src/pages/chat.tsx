      ...
      <form class="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
        <article class="mb-5">
          ...
          <p class="mb-2 text-gray-900 dark:text-white">
            ...
            Let's schedule a kick-off meeting and workshop this week. It would
            be great to gather everyone involved in the design project. Let me
            know about your availability in the thread.
          </p>
        ...
        <article class="mb-5">
          ...
          <div class="items-center 2xl:flex 2xl:space-x-4">
            <div class="mb-3.5 flex items-center rounded-lg border border-gray-200 p-3 dark:border-gray-700">
              <div class="bg-primary-100 dark:bg-primary-900 mr-3 flex h-10 w-10 items-center justify-center rounded-lg">
                <svg
            ...
            <div class="mb-3.5 flex items-center rounded-lg border border-gray-200 p-3 dark:border-gray-700">
              <div class="mr-3 flex h-10 w-10 items-center justify-center rounded-lg bg-teal-100 dark:bg-teal-900">
                <svg
                  class="h-5 w-5 text-teal-600 lg:h-6 lg:w-6 dark:text-teal-300"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                  aria-hidden="true"
        ...
        <article class="mb-5 pl-12">
          ...
          <span class="text-primary-700 dark:text-primary-500 inline-flex cursor-pointer items-center text-xs font-medium hover:underline sm:text-sm">
            Hide thread
            <svg
              class="ml-1 h-5 w-5"
              fill="currentColor"
