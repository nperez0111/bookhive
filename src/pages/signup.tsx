...
export const Signup: FC<{
  ...
  <div class="animate-fade relative flex min-h-full flex-col items-center justify-center px-6 py-12 duration-300 lg:px-8">
    ...
    <ThemeToggle class="text-muted-foreground hover:text-foreground absolute top-4 right-4 z-20 flex size-10 items-center justify-center rounded-md lg:top-6 lg:right-6" />
    <ThemeToggleScript />
