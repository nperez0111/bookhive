...
export const CardHeader: FC<{ class?: string; children?: Child }> = ({
  ...
  return (
    <div class={className ? `card-header ${className}` : "card-header"}>
      {children}
    </div>
  );
};
...
export const CardTitle: FC<{ class?: string; children?: Child }> = ({
  ...
  return (
    <h2 class={className ? `card-title ${className}` : "card-title"}>
      {children}
    </h2>
  );
};
...
export const CardBody: FC<{ class?: string; children?: Child }> = ({
  ...
  return (
    <div class={className ? `card-body ${className}` : "card-body"}>
      {children}
    </div>
  );
};
